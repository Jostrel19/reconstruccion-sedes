...
10 de agosto de 2026: presupuesto por sede, contraste contra el modelo paramétrico, y —cuando esté
disponible la información de contratación— seguimiento del plan de acción de cada sede hasta la
...
Es la **contrapartida municipal del modelo paramétrico** que la Dirección de Planeación produjo el
08-09-2026 (`ESTIMACION COSTOS RECONSTRUCCION SEDES OFICIALES 08_09_2026.xlsx`, $23.348.062.500
sobre 456 sedes valoradas). El oficio de ese estudio dice que la estimación **«no constituye
presupuesto de obra»**; este instrumento es el levantamiento real de cantidades.

Criterio rector, del que se deriva todo lo demás:

> El dato debe salir **comparable sede por sede contra el valor del modelo**. Si el municipio digita
> en texto libre, el cruce es imposible y la cifra no se puede sustentar ante el MEN, la UNGRD ni
> Hacienda.

El contraste se hace contra el **costo directo**, nunca contra el total con AU: el modelo excluye
AIU, interventoría, estudios y diseños e IVA, así que los presupuestos municipales llegarán por
encima **por construcción**. Esa diferencia es esperada, no un error.
...
**`PresupuestosSedes`** (una fila por sede radicada):
`id_radicado · dane_sede · municipio · dane_ie · institucion · sede · zona · matricula ·
...
**`ItemsPresupuesto`** (N filas por radicado):
`id_radicado · n_item · capitulo_dano · descripcion · unidad · cantidad · valor_unitario ·
valor_total`

**Estados:** `PENDIENTE · SIN_AFECTACION · BORRADOR · RADICADO · EN_VERIFICACION ·
REQUIERE_AJUSTE · APROBADO`
...
| Tipo censo | Sedes | Tratamiento |
|---|---:|---|
| 1 Colapso total o parcial | 8 | abierta para presupuesto |
| 2 Riesgo inminente de colapso | 20 | abierta para presupuesto |
| 3 Afectaciones estructurales/funcionales | 140 | abierta para presupuesto |
| 4 Afectaciones menores | 386 | abierta para presupuesto |
| 5 Sin afectación | 271 | pre-marcada, solo confirmar |
| 6 No es posible determinar | 15 | declaración expresa |
| 7 Sin revisar | 135 | declaración expresa |
...
| Q-3 | Aval de Planeación a los umbrales de alerta A > 12 % y U > 8 % |
